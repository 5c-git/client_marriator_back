...
Route::group(["middleware" => ["auth:api", "scope:personalArea"]], function () {
    Route::group(['prefix' => 'personal'], function () {
        ...
        Route::group(['prefix' => 'documents'], function () {
            ...
            Route::post('/createTestDoc/', 'App\Http\Controllers\PersonalArea\DocumentsController@createDocument')->name('createDocument');
        ...
        Route::middleware([CheckRole::class.':client'])->group( function () {
            ...
            Route::get('/getProjectForOrder','App\Http\Controllers\UserRoles\ClientController@getProjectForOrder')->name('getProjectForOrder');
        });
        Route::middleware([CheckRole::class.':manager'])->group( function () {
...
//
        ...
        Route::post('/acceptSpecialist','App\Http\Controllers\UniversalController@acceptSpecialist')->name('acceptSpecialist');
        Route::post('/declinedSpecialist','App\Http\Controllers\UniversalController@declinedSpecialist')->name('declinedSpecialist');
