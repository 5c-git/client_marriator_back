...
@section('content_header')
    <div class="row">
        <div class="col-sm-11">
            <h1>Создание Длины волос</h1>
        </div>
    </div>
@stop

@section('content')
    <form class="status formCustomSubmit" action="{{route('hair_lengthCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('hair_lengthList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
