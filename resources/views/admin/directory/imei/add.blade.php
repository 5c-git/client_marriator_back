...
@section('content_header')
    <div class="row">
        <div class="col-sm-11">
            <h1>Создание Imei телефона</h1>
        </div>
    </div>
@stop

@section('content')
    <form class="status formCustomSubmit" action="{{route('imeiCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('imeiList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
