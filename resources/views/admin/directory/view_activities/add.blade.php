...
@section('content')
    <form class="status formCustomSubmit" action="{{route('view_activitiesCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="external_id" id="external_id">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="offset-sm-2 col-sm-10">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" style="margin-top: -1.5rem" name="self_employed" value="1" id="self_employed">
                </div>
            </div>
        </div>
