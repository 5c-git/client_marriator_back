...
@section('content')
    <form class="status formCustomSubmit" action="{{route('offer_searchCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('offer_searchList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
