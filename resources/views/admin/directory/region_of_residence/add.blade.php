...
@section('content_header')
    <div class="row">
        <div class="col-sm-11">
            <h1>Создание Региона проживания</h1>
        </div>
    </div>
@stop

@section('content')
    <form class="status formCustomSubmit" action="{{route('region_of_residenceCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('region_of_residenceList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
