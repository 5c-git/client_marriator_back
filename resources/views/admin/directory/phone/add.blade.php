...
@section('content_header')
    <div class="row">
        <div class="col-sm-11">
            <h1>Создание Модели телефона</h1>
        </div>
    </div>
@stop

@section('content')
    <form class="status formCustomSubmit" action="{{route('phoneCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('phoneList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
