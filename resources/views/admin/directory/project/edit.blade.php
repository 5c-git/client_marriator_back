...
@section('content')
    ...
    <form class="status formCustomSubmit" action="{{route('projectEditAjax')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="time" class="form-control" name="time_start" value="{{$edit->time_start?->format('H:i')}}" id="time_start" >
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="time" class="form-control" name="time_end" value="{{$edit->time_end?->format('H:i')}}" id="time_end" >
            </div>
        </div>
