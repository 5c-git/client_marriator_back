...
@section('content')
    <form class="status formCustomSubmit" action="{{route('countryCreateAjax')}}">
        @csrf
       ...
       // parentFields
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="{{route('countryList')}}" style="margin-left: 10px" class="btn btn-secondary btn-md active"
