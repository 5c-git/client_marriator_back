...
@section('content')
    ...
    @php
        ...
        $listData[] = [$document->id , '<a target="_blank" href="http://preprod.marriator-api.fivecorners.ru/storage/'.$document->link.'"> '.$document->link.' </a>' ,$document->status->name,$document->unprocessed_data];
        }
