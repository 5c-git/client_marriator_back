...
@section('content_header')
    <div class="row">
        <div class="col-sm-11">
            <h1>{{$docEnum->getName()}}</h1>
        </div>
    </div>
@stop

@section('content')
    <form class="status formCustomSubmit" action="{{route('documentsCreateAjax')}}">
        @csrf
        ...
        <div class="form-group row" style="display: none">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="type" id="type" value="{{$docEnum->value}}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="number" class="col-sm-2 col-form-label">Номер документа</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="number" id="number" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="place" class="col-sm-2 col-form-label">Место подписания</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row" style="display: none">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="template" id="template" value="{{$docEnum->getTemplate()}}" required>
            </div>
        </div>
