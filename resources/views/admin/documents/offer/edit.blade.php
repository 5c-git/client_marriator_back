...
@section('content')
    ...
    <form class="status formCustomSubmit" action="{{route('documentsEditAjax')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="number" id="number" value="{{$edit->number}}" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="place" class="col-sm-2 col-form-label">Место подписания</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="place" id="place" value="{{$edit->place}}" required>
            </div>
        </div>
