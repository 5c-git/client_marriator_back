...
class SmenaEventProcessor
{
    ...
    public function run(): void
    {
        ...
        do {
            ...
            SmenaPollState::updateCursor($cursor ?? '');
    ...
    private function process(array $event): void
    {
        ...
        $log = SmenaEventLog::query()->create([
            'event_id' => (string) \Illuminate\Support\Str::uuid(),
            'event_type' => $eventType,
            'event_ts' => $event['event_ts'] ?? now()->toIso8601String('microsecond'),
            'direction' => 'in',
    ...
    {
        return SmenaEventLog::query()->where('source_event_id', $eventId)->exists();
    }
